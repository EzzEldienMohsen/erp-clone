...
const Header = () => {
  ...
  return (
    <div className="w-[100vw] fixed top-0 left-0 bg-transparent flex items-center justify-start border-b-2 border-b-[#ddd] ">
      <button
        onClick={openDrawer}
        className="h-[95px] w-[25vw] md:w-[15vw] bg-inherit flex justify-center items-center text-white gap-2 hover:bg-[#9b0808] active:bg-[#9b0808] border-r-2 border-r-[#ddd] border-spacing-2 bg-[#9b0808] lg:bg-transparent"
      >
